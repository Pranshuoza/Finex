...
const Profile = () => {
  ...
  const [residentialStatus, setResidentialStatus] = useState(profile?.residentialStatus || '');
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <form onSubmit={handleEditProfile} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-sm font-medium text-gray-700 uppercase tracking-wide">Name</Label>
                <Input
                  id="name"
                  name="name"
                  placeholder="Name"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-sm font-medium text-gray-700 uppercase tracking-wide">Email</Label>
                <Input
                  id="email"
                  name="email"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="mobileNumber" className="text-sm font-medium text-gray-700 uppercase tracking-wide">Mobile Number</Label>
                <Input
                  id="mobileNumber"
                  name="mobileNumber"
              ...
              <div className="space-y-2">
                <Label htmlFor="age" className="text-sm font-medium text-gray-700 uppercase tracking-wide">Age</Label>
                <Input
                  id="age"
                  name="age"
                  type="number"
              ...
              <div className="space-y-2">
                <Label htmlFor="residentialStatus" className="text-sm font-medium text-gray-700 uppercase tracking-wide">Residential Status</Label>
                <Select name="residentialStatus" defaultValue={profile?.residentialStatus} value={residentialStatus} onValueChange={setResidentialStatus}required>
                  <SelectTrigger id="residentialStatus" className="border border-gray-300 rounded-xl bg-white py-3 px-4 focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm">
        ...
        <Dialog open={showPasswordModal} onOpenChange={setShowPasswordModal}>
          <DialogContent className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8 max-w-md animate-in fade-in-0 zoom-in-95 duration-200">
            ...
            <div className="space-y-6 mt-6">
              <div className="space-y-2">
                <Label htmlFor="currentPassword" className="text-sm font-medium text-gray-700 uppercase tracking-wide">
                  Current Password
                </Label>
                <Input
                  id="currentPassword"
